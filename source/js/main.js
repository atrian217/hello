$(document).ready(function () {
  ...
  function startTimeSalam() {
    ...
    if (hSalam < 4) {
      ...
      kata2 = "Semoga mimpi indah 😊 <i class='fa fa-smile'></i>";
    } else {
      if (hSalam < 11) {
        ucapanSalam = "Selamat Pagi kamu"
        kata1 = "Jangan lupa sarapan";
        kata2 = "Semoga hari hari mu menyenangkan 😁 <i class='fa fa-smile'></i>";
      } else {
        if (hSalam < 16) {
          ucapanSalam = "Selamat Siang kamu"
          kata1 = "Jangan lupa makan siang";
          kata2 = "Jangan lupa shalat dzuhur juga 😇 <i class='fa fa-smile'></i>";
        } else {
          if (hSalam < 20) {
            ucapanSalam = "Selamat Sore kamu"
            kata1 = "Jangan lupa mandi hahaha";
            kata2 = "Jangan lupa shalat ashar juga yaa 😊 <i class='fa fa-smile'></i>";
          } else {
              ucapanSalam = "Selamat Malam Kamu"
              kata1 = "Jangan tidur malam";
              kata2 = "Semoga mimpi indah 😊 <i class='fa fa-smile'></i>";
